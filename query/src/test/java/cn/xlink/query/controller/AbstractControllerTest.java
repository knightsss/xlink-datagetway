...
import cn.xlink.query.Configuration;
import cn.xlink.query.domain.Metric;
import cn.xlink.query.domain.RequestBody;
import cn.xlink.query.serialization.SerializationProvider;
import cn.xlink.query.utils.CorpAuth;
...
public class AbstractControllerTest {
    ...
    public AbstractControllerTest() throws Exception {
        ...
        this.controller = new AbstractController(config.getProperties(), config.getProxyMap(), config.getServiceMap(), config.getDatasetMetadataService());
    }
