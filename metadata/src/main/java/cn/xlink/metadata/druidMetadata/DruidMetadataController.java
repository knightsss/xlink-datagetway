...
public class DruidMetadataController
{
	...
	public Object create(Request request, Response response)
	{
		...
		// check auth
		if (!checkAuth(request, response, entity)) return null;
	...
	private boolean checkAuth(Request request, Response response, DruidMetadata entity) {
		try{
			String corpId = this.authCheck.getCorpId(request, response);
			if (entity != null) {
