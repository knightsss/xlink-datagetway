...
implements Linkable
{
	...
	@Embedded("time_field")
	private DatasetMetadataFieldEntity timeField;
	...
	public DatasetMetadataFieldEntity getTimeField() {
		return timeField;
	}

	public void setTimeField(DatasetMetadataFieldEntity timeField) {
